...
ZigbeeSerialportParser::ZigbeeSerialportParser()
{
...
void ZigbeeSerialportParser::clear()
{
    if (current_frame)
    {
...
int ZigbeeSerialportParser::add_data(unsigned char *data, unsigned int len)
{
    unsigned char  ch;
...
ZigbeeSerialportCommand *ZigbeeSerialportParser::get_frame()
{
    ...
    return ZigbeeSerialportCommand::create_from_buffer(buf, len);
}
