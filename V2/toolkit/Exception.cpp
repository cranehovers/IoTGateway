...
GWSP_IMPLEMENT_EXCEPTION(LogicException, Exception, "Logic exception")
GWSP_IMPLEMENT_EXCEPTION(AssertionViolationException, LogicException, "Assertion violation")
GWSP_IMPLEMENT_EXCEPTION(NullPointerException, LogicException, "Null pointer")
