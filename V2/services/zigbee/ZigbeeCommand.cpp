...
unsigned char *ZigbeeCommand::base()
{
    if (command)
    {
        return command;
...
unsigned int ZigbeeCommand::size()
{
    if (command_size)
    {
        return command_size;
...
ZigbeeCommand *ZigbeeCommand::create_from_buffer(unsigned char *buf, unsigned short len)
{
    ZigbeeCommand *cmd = new ZigbeeCommand();
...
ZigbeeCommand *ZigbeeCommand::create_IEEE_ADDR_cmd(unsigned char short_addr[2],
...
ZigbeeCommand *ZigbeeCommand::create_ACTIVE_EP_cmd(unsigned char dst_short_addr[2], 
...
ZigbeeCommand *ZigbeeCommand::create_EP_SIMPLE_DESC_cmd(unsigned char dst_short_addr[2], 
                                                                    unsigned char interest_short_addr[2],
                                                                    unsigned char ep)
{
 ZigbeeCommand *cmd = new ZigbeeCommand();
...
ZigbeeCommand *ZigbeeCommand::create_AF_DATA_REQ_cmd(unsigned char dst_short_addr[2],
